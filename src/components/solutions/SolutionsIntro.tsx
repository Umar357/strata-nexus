...
const LINE_1 = "Solutions that span".split(" ");
const LINE_2_PRE = "every layer of your".split(" ");
const ACCENT = "enterprise stack.";
...
export default function SolutionsIntro() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 text-center">
      ...
      >
        From the code you ship to the building it runs in — we design, build and
        operate every layer as one coherent system. Pick one, or let us unify
        them all.
      </motion.p>
    </div>
  );
