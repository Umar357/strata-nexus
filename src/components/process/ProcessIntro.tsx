...
const LINE_1 = "Five stages.".split(" ");
const LINE_2_PRE = "One team across".split(" ");
const ACCENT = "all of them.";
...
export default function ProcessIntro() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 text-center">
      ...
      >
        The same engineers from Discover to Operate. Concrete artifacts at every
        stage. The path from "we should rebuild this" to "it's running in
        production" — laid out plainly.
      </motion.p>
    </div>
  );
}
