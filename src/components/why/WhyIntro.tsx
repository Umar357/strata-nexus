...
const LINE_1 = "Six disciplines.".split(" ");
const LINE_2_PRE = "One team. Built".split(" ");
const ACCENT = "to stay.";
...
export default function WhyIntro() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 text-center">
      <SectionLabel>Why Strata Nexus</SectionLabel>
      ...
      >
        Picking technology partners shouldn't mean choosing between speed,
        depth and accountability. Here's the difference between the way most
        engagements work — and the way ours do.
      </motion.p>
    </div>
  );
}
